...
export default function Home() {
    ...
    return (
        <>
            <div onClick={() => { setIsActive(!isActive) }} className='fixed right-0 m-[20px] z-2 w-[80px] h-[80px] rounded-full bg-[#455CE9] cursor-pointer flex items-center justify-center' >
